...
export const ragArchitectureSpec: ToolSpec = {
  ...
  result: {
    blocks: [
      ...
      {
        kind: "prose",
        keys: ["summary", "rationale"],
        title: "Analysis",
        description: "Written over the selection the engine made, not instead of it.",
      },
      ...
      },
      {
        ...
        key: "measure_first",
        title: "Measure first",
        description: "Before tuning anything, get a number for each of these.",
      },
